...
/*
 ...
 1.插件调用代码： $("#fnTimeCountDown").fnTimeCountDown("2018/07/08 18:45:13");
 2.如果一个页面同时调用多个倒计时也很简单，比如相同地方有一个相同类名：fnTimeCountDown 我们就可以使用这个类名调用即可$(".fnTimeCountDown").fnTimeCountDown("2018/07/08 18:45:13");
 ...
 如：
 <div class="fnTimeCountDown" data-end="2018/07/08 18:45:13">......</div>
 这样子*/
